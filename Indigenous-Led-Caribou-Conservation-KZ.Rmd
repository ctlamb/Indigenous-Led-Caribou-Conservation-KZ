...
#Study Area Map
```{r sa map, results='hide', message=FALSE, warning=FALSE}
...
```{r PA map, results='hide', message=FALSE, warning=FALSE}
####PA
...
```{r Pop trend plot, results='hide', message=FALSE, warning=FALSE}
###load data
...
#Plot Disturbances
```{r Ploy Disturbance, results='hide', message=FALSE, warning=FALSE}
